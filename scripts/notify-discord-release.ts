  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new StudyFrame prerelease is available for nightly testers."
          : "A new StudyFrame latest release is available.",
...
).pipe(Command.withDescription("Post a StudyFrame release announcement to Discord."));
