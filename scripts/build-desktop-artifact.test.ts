...
it.layer(NodeServices.layer)("build-desktop-artifact", (it) => {
  ...
  it("switches desktop packaging product names to nightly for nightly builds", () => {
    assert.equal(resolveDesktopProductName("0.0.17"), "StudyFrame (Alpha)");
    assert.equal(resolveDesktopProductName("0.0.17-nightly.20260413.42"), "StudyFrame (Nightly)");
  });

  it("uses StudyFrame artwork for desktop packaging icons", () => {
