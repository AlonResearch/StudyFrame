...
const DESKTOP_BACKEND_ENV_NAMES = [
  "STUDYFRAME_PORT",
  "STUDYFRAME_MODE",
  "STUDYFRAME_NO_BROWSER",
  "STUDYFRAME_HOST",
  "STUDYFRAME_DESKTOP_WS_URL",
  "STUDYFRAME_DESKTOP_LAN_ACCESS",
  "STUDYFRAME_DESKTOP_LAN_HOST",
  "STUDYFRAME_DESKTOP_HTTPS_ENDPOINTS",
  "STUDYFRAME_TAILSCALE_SERVE",
  "STUDYFRAME_TAILSCALE_SERVE_PORT",
] as const;
