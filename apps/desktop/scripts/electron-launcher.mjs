// This file mostly exists because we want dev mode to say "StudyFrame (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "StudyFrame (Dev)" : "StudyFrame (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.studyframe.app.dev" : "com.studyframe.app";
