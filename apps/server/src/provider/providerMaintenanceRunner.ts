            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but StudyFrame could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but StudyFrame still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
